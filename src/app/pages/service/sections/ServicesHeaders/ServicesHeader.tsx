    ...
    return (
        <section className="relative h-[70vh] bg-white pt-5 overflow-hidden">
            ...
            <div className="absolute -left-10 bottom-0 lg:top-50 w-30 xsm:w-40 sm:w-56 sm:-left-14 float">
                <Image src={'/assets/boxHeader.png'} alt="Service Mockup 1" className="object-cover h-full w-full rotate-12" width={900} height={900} />
            </div>

            {/* Right Mockups */}
            <div className="absolute top-0 w-30 xsm:w-40 sm:w-56 xl:w-72 -right-10 lm:-right-5 sm:-right-14 xl:-right-20 float">
                <Image src={'/assets/starHeader.png'} alt="Service Mockup 2" className="object-cover h-full w-full rotate-12" width={900} height={900} />
            </div>
        </section>
    );
};
